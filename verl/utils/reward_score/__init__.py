...
def default_compute_score(
    ...
    **kwargs,
    ...
    elif data_source == "kamed":
        from . import doctor_reward

        res = doctor_reward.compute_score(
            solution_str=solution_str,
            ground_truth=ground_truth,
            conversation_history=extra_info.get("interaction_kwargs", {}).get("query", "") if extra_info else "",
            disease=extra_info.get("interaction_kwargs", {}).get("disease", "") if extra_info else "",
        )
    else:
